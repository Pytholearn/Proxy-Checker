...
autoupgrader.set_url("https://raw.githubusercontent.com/Pytholearn/Proxy-Checker/refs/heads/main/version")
autoupgrader.set_download_link("https://github.com/Pytholearn/Proxy-Checker.git")
autoupgrader.set_current_version("1.6.3")
